...
<div class="max-w-4xl mx-auto p-6 bg-white dark:bg-gray-800 shadow-md rounded-lg mt-5">
    <h1 class="text-2xl font-bold mb-4 text-gray-800 dark:text-gray-200 text-center">Lista de Categorias</h1>
            ...
            <tbody>
                ...
                <tr class="bg-white dark:bg-gray-700">
                    ...
                    <div class="flex justify-center gap-2">
                            <a href="{{ route('categorias.show', $categoria) }}" class="text-blue-500 hover:text-blue-500 dark:text-blue-300">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                                    <path d="M4 2v20l2-1 2 1 2-1 2 1 2-1 2 1 2-1 2 1V2l-2 1-2-1-2 1-2-1-2 1-2-1-2 1Z"/>
                                    <path d="M14 8H8"/><path d="M16 12H8"/><path d="M13 16H8"/>
                                </svg>
                            </a>
                            <a href="{{ route('categorias.edit', $categoria) }}" class="text-green-500 hover:text-green-500 dark:text-green-300">
