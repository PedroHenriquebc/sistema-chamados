...
<div class="container mx-auto p-6">
    <h1 class="text-2xl font-bold mb-4 text-gray-800 dark:text-gray-200">Lista de Categorias</h1>
    ...
    <div class="flex justify-between mb-4">
        <a href="{{ route('categorias.create') }}" class="px-4 py-2 bg-blue-500 text-white rounded-lg hover:bg-blue-600 dark:bg-blue-600 dark:hover:bg-blue-500">Criar Categoria</a>
    </div>
        ...
        <table class="w-full border-collapse border border-gray-300 dark:border-gray-700">
            ...
            <tbody>
                ...
                <tr class="bg-white dark:bg-gray-700">
                    <td class="py-2 px-4 border dark:border-gray-600 text-gray-900 dark:text-gray-100">{{ $categoria->id }}</td>
                    <td class="py-2 px-4 border dark:border-gray-600 text-gray-900 dark:text-gray-100">{{ $categoria->nome }}</td>
                    <td class="py-2 px-4 border dark:border-gray-600 text-gray-900 dark:text-gray-100">
                    <div class="flex justify-center gap-2">
                            <a href="{{ route('categorias.show', $categoria) }}" class="text-blue-500 dark:text-blue-300">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                                    <path d="M4 2v20l2-1 2 1 2-1 2 1 2-1 2 1 2-1 2 1V2l-2 1-2-1-2 1-2-1-2 1-2-1-2 1Z"/>
                                    <path d="M14 8H8"/><path d="M16 12H8"/><path d="M13 16H8"/>
                                </svg>
                            </a>
                            <a href="{{ route('categorias.edit', $categoria) }}" class="text-green-500 dark:text-green-300">
                            ...
                            @csrf
                            @method('DELETE')
                            <button type="submit" class="text-red-500 dark:text-red-300" onclick="return confirm('Tem certeza que deseja excluir?')">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
